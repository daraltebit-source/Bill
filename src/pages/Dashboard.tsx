...
export const Dashboard: React.FC<{ 
  ...
  const availableLiquidity = Math.max(0, 100000 - totalDue);
    ...
    <main className="px-4 pt-8 space-y-8 max-w-2xl mx-auto pb-32">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button 
          ...
          className="bg-surface-container-low/40 hover:bg-primary/5 transition-all p-6 rounded-2xl flex flex-col items-center gap-4 border border-outline group shadow-sm text-center w-full"
        >
        ...
        <button 
          ...
          className="bg-surface-container-low/40 hover:bg-tertiary/5 transition-all p-6 rounded-2xl flex flex-col items-center gap-4 border border-outline group shadow-sm text-center w-full"
        >
